...
const DATASOURCES = [
  { id: 'prometheus', name: 'Prometheus', type: 'prometheus', icon: '📊' },
  { id: 'postgres', name: 'PostgreSQL', type: 'postgres', icon: '🐘' }
];

const METRICS = [
  { value: 'cpu_usage', label: 'CPU Usage', icon: '⚡' },
  { value: 'memory_usage', label: 'Memory Usage', icon: '💾' },
  { value: 'disk_io', label: 'Disk I/O', icon: '💿' },
  { value: 'network_traffic', label: 'Network Traffic', icon: '🌐' },
  { value: 'request_count', label: 'Request Count', icon: '📈' },
  { value: 'response_time', label: 'Response Time', icon: '⏱️' },
  { value: 'error_rate', label: 'Error Rate', icon: '⚠️' }
];
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="query-editor-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-tabs">
          <button
            className={`modal-tab ${activeTab === 'configuration' ? 'active' : ''}`}
            ...
            <>
              ...
              <div className="editor-section">
                ...
                <div className="datasource-grid">
                  {DATASOURCES.map(ds => (
                    <div
                      key={ds.id}
                      className={`datasource-card ${datasource === ds.id ? 'selected' : ''}`}
                      onClick={() => setDatasource(ds.id)}
                    >
                      <span className="datasource-icon">{ds.icon}</span>
              ...
              <div className="editor-section">
                ...
                <p className="help-text">
                  💡 Leave empty to use the default query for the selected metric
                </p>
              </div>
              ...
              <div className="editor-section">
                ...
                <div className="interval-grid">
                  {INTERVALS.map(int => (
                    <div
                      key={int.value}
                      className={`interval-card ${interval === int.value ? 'selected' : ''}`}
